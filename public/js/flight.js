						...
						$.each(form[0].elements,function(index,element){
							if(element.name==="rs_chk_in"||element.name==="rs_chk_out"){
								...
								if(element.value.length===3){
									stringAirCode += "rs_o_aircode="+element.value+
													"&rs_o_city="+element.value+"&";
									...
									switch(type){
										case 'AIR':
											stringAirCode += "rs_o_aircode="+code+
														"&rs_o_city="+element.value+"&";
										break;
										case 'CITY':
											stringAirCode += "rs_o_cityid="+code+
														"&rs_o_city="+element.value+"&";
										break;
									}
									send = true;
								...
								if(element.value.length===3){
									stringAirCode += "rs_d_aircode="+element.value+"&rs_d_city=&";
								}else{
									type = $(element).data("type");
									code = $(element).data("code");
									switch(type){
										case 'AIR':
											stringAirCode += "rs_d_aircode="+code+
														"&rs_d_city="+element.value+"&";
										break;
										case 'CITY':
											stringAirCode += "rs_d_cityid="+code+
														"&rs_d_city="+element.value+"&";
										break;
									}
								}
